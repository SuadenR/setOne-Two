...
const function1 = (parameter1, parameter2) => `The first parameter is ${parameter1}. The second parameter is ${parameter2}`

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

console.log(function1('firstparam', 'secondparam'))
...
const pricesPlusTax = (array, callback) => {
    for (let i = 0; i < array.length; i++) {
        let newTotal = (array[i] + (array[i] * .2))
        totalCost.push(newTotal)
    }
    callback(totalCost)
}
